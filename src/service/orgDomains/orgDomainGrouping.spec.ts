...
describe('Organisation domain grouping', () => {
  it('Should group organisations by domains', () => {
    ...
    const od4 = new OrganisationDomain()
    ...
    const organisationDomains: OrganisationDomain[] = [od1, od2, od3, od4]

    const groupedOrganisations = groupOrganisationsByDomain(domains, organisationDomains)
